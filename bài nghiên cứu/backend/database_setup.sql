...
CREATE TABLE IF NOT EXISTS pa_salary_composition (
    ...
    value_type INT COMMENT '0: Số, 1: Tiền tệ, 2: Chữ, 3: Ngày',
...
VALUES 
('00000000-0000-0000-0001-000000000001', 'Thông tin nhân viên'),
...
INSERT IGNORE INTO pa_salary_composition (salary_component_id, salary_component_code, salary_component_name, applied_unit_id, salary_component_system_id, attribute, value_type, value, status, source)
VALUES 
(UUID(), '1', '1', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0001-000000000001', 0, 0, '-', 1, 'Tự thêm'),
(UUID(), '465ERTERT', 'PC CKH121', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0001-000000000002', 1, 1, '1000000', 1, 'Tự thêm'),
(UUID(), 'A', 'A', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0001-000000000003', 1, 1, '300', 0, 'Tự thêm'),
(UUID(), 'AVA', 'ava', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0001-000000000001', 1, 1, '= TONG_CONG_...', 0, 'Tự thêm'),
(UUID(), 'BAC_LUONG', 'Bậc lương', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0001-000000000001', 0, 2, '-', 1, 'Tự thêm'),
(UUID(), 'BANG_THUE', 'Bảng thuế', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0001-000000000004', 0, 3, '5.000.000', 1, 'Tự thêm'),
(UUID(), 'BHTN', 'BHTN', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0001-000000000005', 2, 1, '=BHTN', 1, 'Tự thêm'),
(UUID(), 'BHTN_CONG_TY_DONG', 'BHTN (Công ty đóng)', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0001-000000000005', 0, 1, '=BHTN_CONG_T...', 1, 'Tự thêm'),
(UUID(), 'BHXH', 'BHXH', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0001-000000000005', 2, 1, '=ROUND(BHXH, 1)', 1, 'Tự thêm'),
(UUID(), 'BHYT', 'BHYT', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0001-000000000005', 2, 1, '=BHYT', 1, 'Tự thêm'),
(UUID(), 'CA_DAC_BIET', 'Ca đặc biệt', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0001-000000000006', 0, 0, '-', 1, 'Tự thêm'),
(UUID(), 'CDP', 'Công đoàn phí', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0001-000000000005', 2, 1, '=if( TINH_CHAT_L... )', 1, 'Tự thêm'),
(UUID(), 'CHECKBOX', 'Checkbox', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0001-000000000001', 0, 2, '-', 1, 'Tự thêm'),
(UUID(), 'CHUYEN_DOANH_SO', 'Chuyên doanh số', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0001-000000000004', 1, 1, '=E6/2', 1, 'Tự thêm'),
(UUID(), 'COMBOBOX', 'combobox', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0001-000000000001', 0, 2, '-', 1, 'Tự thêm'),
(UUID(), 'CONG_AN_CA', 'Công ăn ca', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0001-000000000006', 0, 0, '-', 1, 'Tự thêm'),
(UUID(), 'PC_AN_TRUA', 'Phụ cấp ăn trưa', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0001-000000000004', 1, 1, '730000', 1, 'Tự thêm'),
(UUID(), 'PC_DIEN_THOAI', 'Phụ cấp điện thoại', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0001-000000000004', 1, 1, '200000', 1, 'Tự thêm'),
(UUID(), 'THU_NHAP_KHAC_1', 'Thu nhập khác 1', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0001-000000000003', 1, 1, '0', 1, 'Tự thêm'),
(UUID(), 'THU_NHAP_KHAC_2', 'Thu nhập khác 2', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0001-000000000003', 1, 1, '0', 1, 'Tự thêm');
...
VALUES 
(UUID(), 'SalaryComponentGrid', 'salary_component_code', 'Mã thành phần', 1, 1, 150, 0),
